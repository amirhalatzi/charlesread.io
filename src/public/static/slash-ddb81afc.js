...
$_mod.def("/charlesread.io$1.0.0/pages/slash/index.marko.init", function(require, exports, module, __filename, __dirname) { window.$initComponents && window.$initComponents()
});
$_mod.run("/charlesread.io$1.0.0/pages/slash/index.marko.init");